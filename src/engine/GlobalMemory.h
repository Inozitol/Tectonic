...
constexpr std::size_t SIZE_PLAYER    = sizeof(Player)+sizeof(Player)%alignof(Player);
...
constexpr std::size_t OFFSET_PLAYER    = OFFSET_TEC_CORE + SIZE_TEC_CORE;


constexpr std::size_t TOTAL_SIZE = OFFSET_PLAYER + SIZE_PLAYER;
...
inline Player* PlayerPtr       = reinterpret_cast<Player*>(memory + OFFSET_PLAYER);
